            ...
            <Container>
                <Row className='my-5'>
                    <Col lg={12} className='d-flex justify-content-center'>
                        <img  style={{width:"1230px" , height:"500px"}} src="https://images.pexels.com/photos/1435904/pexels-photo-1435904.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" className='gif' />
                        {/* <Col lg={6}>
